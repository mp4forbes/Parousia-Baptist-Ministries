...
![Public website navigation with admin gear icon](/admin-guide/screenshots/01-public-nav-gear.png)
...
![Admin login screen — email and password](/admin-guide/screenshots/02-admin-login-step1.png)
...
![Admin login OTP verification screen (English)](/admin-guide/screenshots/03-admin-login-otp-en.png)
...
![Admin dashboard sidebar](/admin-guide/screenshots/04-admin-dashboard-sidebar.png)
...
![Church logo upload area](/admin-guide/screenshots/05-logo-upload.png)
...
![Color adjuster panel](/admin-guide/screenshots/06-color-adjuster.png)
...
![Configure Home Tabs screen](/admin-guide/screenshots/07-home-tabs-config.png)
...
![Ministries configuration screen](/admin-guide/screenshots/08-ministries-config.png)
...
![Daily devotional theme settings](/admin-guide/screenshots/09-devotional-theme.png)
...
![Pastor blog editor](/admin-guide/screenshots/10-blog-editor.png)
...
![Security and admins screen](/admin-guide/screenshots/11-security-admins.png)
...
![Auto-translation controls](/admin-guide/screenshots/12-auto-translate-panel.png)
